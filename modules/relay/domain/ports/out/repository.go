...
type Repository interface {
	...
	// Events
	FindEvents(ctx context.Context, filters map[string]interface{}, limit, offset int) ([]entities.Event, int, error)
	FindEventBySlug(ctx context.Context, slug string) (*entities.Event, error)
